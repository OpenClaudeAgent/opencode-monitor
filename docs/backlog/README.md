...
Plans awaiting execution. Move to `archive/plans/` when completed.

## Active Sprint

See [sprints/](../sprints/) for current work.
...
1. Pick a plan from this backlog
2. Create a sprint in `sprints/YYYY-MM-name.md`
3. Execute the plan
4. Move completed plan to `archive/plans/`
