    ...
    return [
        {
            ...
            "children": [
                ...
                },
                {
                    ...
                    "subagent_type": "quality",  # API uses subagent_type
                    "parent_agent": "user",
...
def _create_traces_from_hierarchy(base_date: datetime) -> list[dict[str, Any]]:
    ...
    return [
        ...
        {
            # Delegation trace: executor → tester
            "trace_id": "trace-003",
            "session_id": "sess-grandchild-001",
            ...
            "tokens_in": 1500,
            "tokens_out": 2500,
            "started_at": (base_date - timedelta(minutes=4)).isoformat(),
        },
        {
            "trace_id": "trace-004",
            "session_id": "sess-child-002",
            ...
            "tokens_in": 1000,
            "tokens_out": 1500,
            "started_at": (base_date - timedelta(minutes=1)).isoformat(),
        },
    ]
